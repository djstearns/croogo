///**************
		...
		function savetoremote(){
			...
			sendit.send({
				//Model Vars
				id: $.name.datid,
				name:$.name.value,age:$.age.value,adult_id:$.adult_id.value,mom:$.mom.valu
				//Model Vars
			});
		...
		$.savebtn.addEventListener('click', function(){
			...
			globalsave(Alloy.Globals.BASEURL+Alloy.Globals.PLUGIN+args.tablename+'/mobilesave', {id: $.name.datid,name:$.name.value,age:$.age.value,adult_id:$.adult_id.value,mom:$.mom.valu},args.model,{id: $.name.datid,name:$.name.value,age:$.age.value,adult_id:$.adult_id.value,mom:$.mom.valu});
			//itemModel.save();
