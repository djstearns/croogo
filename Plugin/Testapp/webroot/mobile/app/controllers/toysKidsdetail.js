///**************
		...
		function savetoremote(){
			...
			sendit.send({
				//Model Vars
				id: $.name.datid,
				kid_id:$.kid_id.value,toy_id:$.toy_id.valu
				//Model Vars
			});
		...
		$.savebtn.addEventListener('click', function(){
			...
			globalsave(Alloy.Globals.BASEURL+Alloy.Globals.PLUGIN+args.tablename+'/mobilesave', {id: $.name.datid,kid_id:$.kid_id.value,toy_id:$.toy_id.valu},args.model,{id: $.name.datid,kid_id:$.kid_id.value,toy_id:$.toy_id.valu});
			//itemModel.save();
